...
namespace nalydmod.Npcs.Enemies.Worms.Gem
{
    internal class AmethystWormHead : AmethystWorm
    {
        ...
        public override void NPCLoot()
        {
            ...
            Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("AmethystFragment"), Main.rand.Next(22, 39));
            Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ItemID.Amethyst, Main.rand.Next(2, 4));
        }
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            ...
            else return SpawnCondition.Cavern.Chance * 0.006f;
        }
