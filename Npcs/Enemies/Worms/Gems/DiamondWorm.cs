...
namespace nalydmod.Npcs.Enemies.Worms.Gem
{
    ...
    internal class DiamondWormHead : DiamondWorm
    {
        ...
        public override void NPCLoot()
        {
            ...
            Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("DiamondFragment"), Main.rand.Next(10, 22));
            Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ItemID.Diamond, Main.rand.Next(2, 4));
        }
    ...
    internal class DiamondWormTail : DiamondWorm
    {
    ...
    public abstract class DiamondWorm : WormDiamond
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Diamond Worm");
        }
        public override void Init()
        {
            minLength = 4;
            maxLength = 19;
            tailType = NPCType<DiamondWormTail>();
            bodyType = NPCType<DiamondWormBody>();
            headType = NPCType<DiamondWormHead>();
            speed = 9.5f;
            turnSpeed = 0.105f;
        }
    }
    ...
    public abstract class WormDiamond : ModNPC
    {
        /* ai[0] = follower
		 * ai[1] = following
