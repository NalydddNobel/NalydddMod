...
namespace nalydmod.Npcs.Enemies.Worms
{
    internal class RubyWormHead : RubyWorm
    {
        ...
        public override void NPCLoot()
        {
            ...
            Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("RubyFragment"), Main.rand.Next(11, 25));
            Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ItemID.Ruby, 2);
        }
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            return SpawnCondition.Cavern.Chance * 0.022f;
        }
